...
function renderHistory() {
    ...
    history.forEach((round, roundIndex) => {
        ...
        round.scores.forEach(score => {
            ...
            html += `<td><div class="score-cell">${score}${arrow}</div></td>`;
        });
        ...
        html += `
            <td class="history-actions">
                ...
                <div class="actions-mobile">
                    <button class="dots-btn" onclick="toggleDropdown(event, this)">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg>
                    </button>
                    <div class="dropdown-menu">
                        <button class="dropdown-item" onclick="editRound(${roundIndex})">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                            ${TRANSLATIONS[currentLang].edit}
                        </button>
                        <button class="dropdown-item delete" onclick="deleteRound(${roundIndex})">
